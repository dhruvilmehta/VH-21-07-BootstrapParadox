...
try{
    ...
    const distance = 0;
    const {name,password,email,pincode,city,state,lat,long,address,number }=req.body;

const newHospital= await Hospital.create({name,password,email,city,pincode,state,lat,long,distance,address,number})
