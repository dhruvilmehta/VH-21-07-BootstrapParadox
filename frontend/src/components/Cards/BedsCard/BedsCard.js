...
function BedsCard({ name, beds, city, state, _id ,icuBeds,oxygen}) {
    ...
    <div className="card border border-secondary">
      <div className="card-body">
        ...
        <div className='text-start'>
          <h6 className="card-subtitle mb-2">Bed : {beds}</h6>
          <h6 className="card-subtitle mb-2">Oxygen : {oxygen} </h6>
          <h6 className="card-subtitle mb-2">ICU beds : {icuBeds} </h6>
        </div>
